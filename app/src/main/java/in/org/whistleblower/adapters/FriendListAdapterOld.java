...
public class FriendListAdapterOld extends RecyclerView.Adapter<FriendListAdapterOld.FriendListViewHolder>
{
    ...
    public FriendListAdapterOld(FriendListActivity activity, List<Accounts> accountsList)
    {
        mActivity = activity;
